"""
This script projects the 129D acoustic embeddings into lower dimensional latent
...
def z_score_transform(df):
    ...
    return transformed_df.set_index("filename")
...
def umap_projections(transformed_df, metadata_df, N_COMP, metric, min_dist, random_state):
    ...
    results = pd.DataFrame(
        {
            "recording_id": transformed_df["filename"],
